...
// =====================================================================
// === FUNÇÃO PARA DETECTAR REJEIÇÃO DE WICK ===
// =====================================================================
function detectWickRejection(candles, isGreenAlert) {
    ...
    try {
        ...
        for (const tf of timeframes) {
            ...
            // Para COMPRA: procurar rejeição de BAIXA (wick inferior longo)
            if (isGreenAlert) {
            ...
            // Para VENDA: procurar rejeição de ALTA (wick superior longo)
            else {
...
// =====================================================================
// === FUNÇÃO CORRIGIDA: FUNDING PENALTY ===
// =====================================================================
...
// =====================================================================
// === FUNÇÃO: ANÁLISE DE DIVERGÊNCIA COM PIVÔ ===
// =====================================================================
...
async function startScanner() {
    ...
    log(`📊 VOLUME DINÂMICO: Base COMPRA ${CONFIG.ALERTS.VOLUME_DIRECTION.DYNAMIC_THRESHOLDS.BASE_BUY}% | Base VENDA ${CONFIG.ALERTS.VOLUME_DIRECTION.DYNAMIC_THRESHOLDS.BASE_SELL}%`, 'success');
    log(`📊 LSR DINÂMICO: Base COMPRA ${CONFIG.LSR_PENALTY.DYNAMIC_THRESHOLDS.BASE_BUY_MAX} | Base VENDA ${CONFIG.LSR_PENALTY.DYNAMIC_THRESHOLDS.BASE_SELL_MIN}`, 'success');
    log(`🕯️ Rejeição de Wick: +${CONFIG.ALERTS.WICK_REJECTION.SCORE_BONUS} pontos`, 'success');
