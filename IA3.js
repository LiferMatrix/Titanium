// ==================== TITANIUM TURBO 2025 – VERSÃO FINAL CORRIGIDA ====================
...
// 48 ATIVOS MAIS LUCRATIVOS DE 2025
const ATIVOS = [
...
(async () => {
    ...
    // ESSA MENSAGEM VAI APARECER SEMPRE – igual à sua versão antiga que funciona
    await tg("<b>TITANIUM TURBO 2025 ATIVADA</b>\n\n48 ativos • Stop 1.9R • TPs 4.5 / 9 / 20R • 70x-100x\n\nBot online !");
    
    console.log("TITANIUM TURBO 2025 rodando – a mais lucrativa de 2025");
        ...
        try {
            ...
            for (const sym in hotList) {
                ...
                try {
                    ...
                    if (okBuy || okSell) {
                        const lev = (e.type==="buy"?cci3<=-120:cci3>=120) ? "70x-100x" : "50x-70x";
