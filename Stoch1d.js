...
async function sendInitializationMessage() {
    try {
        ...
        const message = `_🚀 TITANIUM DIÁRIO INICIADO ✅
📅 ${now.full}
✅ ALERTAS ATIVOS
📊 Estocástico Diário 5.3.3 (OVERSOLD ${CONFIG.STOCHASTIC.OVERSOLD} | OVERBOUGHT ${CONFIG.STOCHASTIC.OVERBOUGHT})
...
async function startBot() {
    try {
        ...
        const testMessage = `_🤖 Bot Titanium Diário iniciando em ${getBrazilianDateTime().full}_`;
...
// Iniciar o bot
console.log('🚀 Iniciando Titanium Diário Bot...');
