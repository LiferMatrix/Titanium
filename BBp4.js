...
const CONFIG = {
    ...
    SCAN: {
        BATCH_SIZE: 10, // Aumentado para processar mais moedas
        SYMBOL_DELAY_MS: 100, // Reduzido para ser mais rápido
        REQUEST_TIMEOUT: 10000,
        COOLDOWN_AFTER_BATCH_MS: 800,
        MAX_REQUESTS_PER_MINUTE: 1200,
        CACHE_DURATION_SECONDS: 30,
        TOP_SYMBOLS_LIMIT: 300 // ALTERADO: Agora analisa 300 moedas
    },
    ALERTS: {
        COOLDOWN_MINUTES: 60, // Aumentado para 60 minutos base
        ...
        COOLDOWN_BY_TIMEFRAME: {
            '1h': 30,  // Timeframe 1h: 30 minutos entre alertas
            '4h': 60,  // Timeframe 4h: 60 minutos entre alertas
            '1d': 120  // Timeframe 1d: 120 minutos entre alertas
        },
        DAILY_LIMITS: {
            TOP_10: 25,
            TOP_50: 40,
