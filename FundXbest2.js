...
// =====================================================================
// === FUNÇÃO PARA VERIFICAR TENDÊNCIA DO LSR (15 MINUTOS) ===
// =====================================================================
...
// =====================================================================
// === ATUALIZAR LISTA DE SÍMBOLOS COM CRITÉRIOS ===
// =====================================================================
async function updateWatchedSymbols(cvdManager) {
    ...
    for (const s of symbols) {
        if (funding[s] !== undefined && lsr[s] !== null && lsr[s] > 0) {
            ...
            const lsrTrendData = await getLSRTrend(s);
...
async function startMonitor() {
    ...
    setInterval(async () => {
        console.log(`\n🔄 Executando análise em ${new Date().toISOString()}`);
