...
<b>🎯Probabilidade Ajustada:</b> ${riskAdjustedProbability}% (base: ${baseProbability}%)
<b>📈Distância S/R:</b> ${distancePercent}% ${signal.isBullish ? 'da resistência' : 'do suporte'}

${riskSection}
<b>📋 DETALHES DA ENTRADA:</b>
<b>Entrada Ideal:</b> $${signal.price.toFixed(6)}
<b>Entrada Mínima:</b> $${signal.targetsData.retracementData.minRetracementPrice.toFixed(6)}
<b>Entrada Máxima:</b> $${signal.targetsData.retracementData.maxRetracementPrice.toFixed(6)}
...
<b>🧠 IA Titanium com Risk Layer - by @J4Rviz.</b>
<i>⚠️ Este é um ALERTA INFORMATIVO, não uma recomendação de investimento.</i>
        `;
