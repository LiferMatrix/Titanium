...
// =====================================================================
// === ATUALIZAR LISTA DE SÍMBOLOS COM CRITÉRIO DE DIVERGÊNCIA, RSI, BOLLINGER E LSR ===
// =====================================================================
async function updateWatchedSymbols(cvdManager) {
    ...
    // LISTA POSITIVA (BEAR): Divergência de BAIXA + RSI 1h > 65 + TOQUE NA BANDA SUPERIOR + LSR > 2.5
    ...
    // LISTA NEGATIVA (BULL): Divergência de ALTA + RSI 1h < 60 + TOQUE NA BANDA INFERIOR + LSR < 1.8
