...
// 🔵 FUNÇÃO ATUALIZADA: Construir mensagem de alerta com ADX 15m e 1h
function buildAlertMessage(isBullish, symbol, priceFormatted, brDateTime, targetsAndStop, 
    ...
    // 🔵 ADICIONAR ADX NA SEÇÃO DE INDICADORES
    message += ` #ADX 15m: ${adx15m.adx} (${adx15m.strength}) ${adx15m.trend}\n`;
    message += ` #ADX 1h: ${adx1h.adx} (${adx1h.strength}) ${adx1h.trend}\n`;
